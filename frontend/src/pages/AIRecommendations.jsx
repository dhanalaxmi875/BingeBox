        ...
        <div className="relative w-full max-w-md mx-auto rounded-2xl bg-[#181818]/90 shadow-2xl border border-[#333] px-8 py-10 mt-4 flex flex-col items-center min-h-[480px]">
          ...
          <div className="w-full flex items-center mb-8">
            <div className="flex-1 h-2 bg-[#232323] rounded-full overflow-hidden">
              <div
                className="h-full bg-[#641374] transition-all duration-300"
          ...
          <div className="w-full flex flex-col flex-1">
              ...
              <div className="grid grid-cols-1 gap-3">
                {steps[step].options.map((opt) => (
                  <button
                    ...
                    className={`w-full py-3 rounded-xl border-2 transition font-semibold text-base flex items-center justify-center gap-2 focus:outline-none focus:ring-2 active:scale-95 duration-150 focus:ring-[#641374] shadow-sm ${
                      inputs[steps[step].name] == opt
                        ? "bg-[#641374] border-[#641374] text-white shadow-lg"
                        : "bg-[#232323] border-[#444] text-white hover:bg-[#641374]/80 hover:border-[#641374]"
                    }`}
                  >
                    {opt}
                  </button>
            ...
            <div className="flex justify-between items-center mt-6">
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg font-semibold transition border-2 border-[#641374] text-white bg-[#] hover:bg-[#641374] ml-2"
              >
