...
- **Email Service**: SendGrid (for password resets)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/bingebox-clone.git
   cd bingebox-clone
   ```
...
The recommendation system leverages **Google's Gemini AI** to provide intelligent movie suggestions based on:

1. **Mood Analysis**
   - Analyzes user's mood from input text
   - Matches mood with movie genres and themes
   - Considers time of day and viewing context

2. **Personalized Suggestions**
   - Learns from watch history
   - Considers previously rated movies
   - Adapts to user preferences over time

3. **Contextual Awareness**
   - Time-based recommendations (e.g., shorter movies for weeknights)
...
- [Gemini AI Documentation](https://ai.google/gemini/)
